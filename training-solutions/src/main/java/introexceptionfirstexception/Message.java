...
public class Message {
    ...
    public static void main(String[] args) {
        ...
        List<String> anotherCodedMessage = Arrays.asList("69", "122", "32", "101", "103", "121", "32", "104", "105", "98", "225", "115", "32", "252", "122", "101", "110", "101", "116", "46"); // 1O1 instead of 101

        System.out.println();
        for (String s: anotherCodedMessage){
            char b = (char) Integer.parseInt(s);
            System.out.print( (char) Integer.parseInt(s));
        }
    }
}
